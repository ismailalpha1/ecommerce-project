        ...
        {availableCategories.map((category) => (
          <button
            ...
            className={`px-5 py-2 text-sm font-bold rounded-full transition duration-200 
              shadow-md ${selectedCategory === category ? 'bg-orange-600 text-white shadow-orange-800/50'
                :'bg-gray-800 text-gray-300 hover:text-orange-400 border border-gray-700'
              }`}
          >
            {category}
          </button>
