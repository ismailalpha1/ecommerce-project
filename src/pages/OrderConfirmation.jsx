  ...
  return (
    <>
      <div className="container mx-auto md:px-8 pt-12">
        ...
        text-center mt-12 border-green-700 text-white"
        >
          ...
          <p className="text-lg text-gray-300 mb-6">
            Your transaction is complete. Tible is proud of you
          </p>

          <div
            className="p-6 bg-green-900/30 border border-green-700 rounded-xl 
          font-mono text-left inline-block text-green-300 text-sm"
          >
          ...
          <Link
            to={"/"}
            className="mt-10 px-4 py-4 bg-orange-600 text-white font-extrabold 
