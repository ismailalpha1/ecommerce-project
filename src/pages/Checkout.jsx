        ...
        <div className="lg:col-span-2 p-8 bg-gray-900 rounded-2xl shadow-2xl border border-gray-800">
          ...
          <form className="space-y-6" action="">
            {Object.keys(deliveryDetails).map((key) => (
              <div key={key}>
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full px-5 py-3 border border-gray-700 rounded-xl 
                  shadow-inner text-white bg-gray-800 placeholder-gray-500"
                />
              </div>
            ))}
            ...
            <div className="pt-6">
              <button
                type="submit"
                className="w-full py-4 bg-orange-600 text-white font-extrabold text-xl 
